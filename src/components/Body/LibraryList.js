...
function LibraryList() {
    ...
    return (
        <div className="w-full lg:w-full md:w-full p-6 md:p-2 bg-background-2 rounded-xl">
            <div className="flex">
                <button className="my-4 mx-2 px-[0.125rem] text-primary text-lg md:text-base border-b-2 border-solid border-primary font-bold">
                    Thư viện
                </button>
                <button className="my-4 mx-2 px-[0.125rem] text-text-0 text-lg md:text-base border-b-2 border-solid border-transparent font-bold">
                    Cập nhật
                </button>
            </div>
